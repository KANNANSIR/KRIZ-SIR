...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`919633687665@s.whatsapp.net`]
...
/*const reply = (teks) => {
			...
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/919633687665?text=hello`}}})
    ...
    const add = function (from, orangnya) {
      ...
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	...
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `KRIZ - SER - OFC.`, "footerText": "*_𝙺𝚁𝙸𝚉 𝚂𝙸𝚁_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    ...
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝙺𝚁𝙸𝚉 𝚂𝙸𝚁 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}

// Katalog

const reply = (teks) => {

             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Kriz*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
...
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Kriz`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/919633687665?text=hello`}}})
...
"externalAdReply": {
                ...
                "title": `Whatsapp-BOT\n𝙺𝚁𝙸𝚉 𝚂𝙸𝚁😎. (@nnda.krnwn_) •Instagram photos and Videos`,
...
"externalAdReply": {
                ...
                "body": `wa.me/919633687665`,

                "mediaType": "10",

                "mediaUrl": `wa.me/919633687665`,

                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",

                "thumbnail": iye,

                "sourceUrl": `wa.me/919633687665`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      ...
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "919633687665@s.whatsapp.net";
...
*Thank you for registering in the 𝙺𝚁𝙸𝚉 𝚂𝙸𝚁😎 Database*
...
*「 𝙺𝚁𝙸𝚉 𝚂𝙸𝚁 」*`
         ...
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             ...
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'ᴋʀɪᴢ', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝙺𝚁𝙸𝚉 𝚂𝙸𝚁*`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       ...
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               footerText: `𝙺𝚁𝙸𝚉 𝚂𝙸𝚁`, imageMessage: imageMsg,
...
│  https://github.com/Krizsir/Kriz-SIR
...
case 'bugreport':
              ...
              xeon.sendMessage('919633687665@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
sendButMessage(from, menu, `𝙺𝚁𝙸𝚉 𝚂𝙸𝚁`, [
...
case "intake3": // by Kriz
      ...
      case "group":
        ...
        sendButMessage(from, `GROUP SETTING`, `Please choose one/nᴋʀɪᴢ sɪʀ`, [
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝙺𝚁𝙸𝚉 𝚂𝙸𝚁', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝙺𝚁𝙸𝚉 𝚂𝙸𝚁`, [
   ...
   case 'bc':
      ...
      case 'broadcast':
        ...
        if (!mek.key.fromMe) return;
             ...
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝙺𝚁𝙸𝚉 𝚂𝙸𝚁 BROADCASTING 」*\n\n${body.slice(4)}`})
...
Krizx = await fetchJson(`https://bx-hunter.herokuapp.com/api/xvideosearch?query=${c}&apikey=${HunterApi}`)
...
case 'attp':
              ...
              if (args.length == 0) return reply(`Example: ${prefix + command} Kriz`)
